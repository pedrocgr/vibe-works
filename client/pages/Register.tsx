...
// Simulated teacher codes validation
const validTeacherCodes = ["PROF2024001", "PROF2024002", "PROF2024003"];
...
export default function Register() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (formData.teacherCode && !validTeacherCodes.includes(formData.teacherCode)) {
      setError("Código do professor inválido. Verifique e tente novamente.");
      return;
    }
    ...
    try {
      ...
      localStorage.setItem("auth", JSON.stringify({
        ...
        teacherCode: formData.teacherCode || null,
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-gray-700">
                  Código do Professor <span className="text-gray-500">(opcional)</span>
                </label>
                <Input
                  type="text"
                  name="teacherCode"
                  ...
                  className="h-10"
                />
                <p className="text-xs text-gray-500">Código fornecido pela sua escola</p>
              </div>
